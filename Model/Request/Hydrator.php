...
namespace Magebit\AgenticCore\Model\Request;
...
/**
 * Fills a request object from a decoded body, building each nested object from the type its getter
 * declares. A trimmed DataObjectHelper: request bodies are plain data, so none of the extension
 * attribute handling applies.
 */
class Hydrator
{
    /**
