...
namespace Magebit\AgenticCore\Test\Unit\Model\Request;

use Magebit\AgenticCore\Model\Request\Hydrator;
use Magebit\AgenticCore\Test\Unit\Model\Request\Stub\FreeFormHolder;
...
class HydratorTest extends TestCase
{
    ...
    public function testAFreeFormMapIsPassedThrough(string $returnType): void
    {
        ...
        $hydrator = new Hydrator($objectFactory, new TypeProcessor(), $methodsMap);
        $hydrator->populateWithArray($holder, ['display' => $value], FreeFormHolder::class);
